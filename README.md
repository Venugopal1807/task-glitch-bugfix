...
All bugfixes were implemented as described, tested (manual and code review), and confirmed working.

## Workflow

- Each bug addressed in a separate branch (`fix/bug-N-*`).
- Merges performed via CLI and VS Code, with merge conflicts resolved carefully.
